...
public class Student implements HasID<String> {
    ...
    public boolean equals(Object o) {
        ...
        if (!comparedStudent.idStudent.equals(this.idStudent)){
            return false;
        }
        if (!comparedStudent.email.equals(this.email)){
            return false;
        }
        if (comparedStudent.grupa != this.grupa){
            return false;
        }
        if (!comparedStudent.nume.equals(this.nume)){
            return false;
        }
        return true;
